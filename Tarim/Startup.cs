...
namespace Tarim
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    {
            //        x.LoginPath = "/Login/Index/"; //giriþ yapýlmadýysa yönlendirilecek konum
            //        x.LogoutPath = "/Login/Logout/"; //çýkýþ
            //    });
            ...
            {
                options.LoginPath = "/Login/Index/"; //giriþ
                options.LogoutPath = "/Login/logout/"; //çýkýþ
